...
import { Music, Mail, Lock, ArrowRight, Loader2, User, Sparkles, Wand2, Zap } from "lucide-react"
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            ...
            <p className="text-xl text-[#4a5568] mb-12 leading-relaxed">
              Join thousands of creators making beautiful tracks. No experience needed, just your creativity.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-xl bg-[#E8E8E8] shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff] flex items-center justify-center shrink-0">
                  <Wand2 className="h-6 w-6 text-[#4a5568]" />
                </div>
                <div>
                  <h3 className="font-bold text-[#1a202c] mb-1">Text to Music</h3>
                  <p className="text-[#4a5568] text-sm">Describe your sound, we'll create it</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-xl bg-[#E8E8E8] shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff] flex items-center justify-center shrink-0">
                ...
                <div>
                  <h3 className="font-bold text-[#1a202c] mb-1">Instant Generation</h3>
                  <p className="text-[#4a5568] text-sm">Get your tracks in seconds</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-10 rounded-[3rem] bg-[#E8E8E8] shadow-[8px_8px_16px_#c5c5c5,-8px_-8px_16px_#ffffff]">
            <div className="mb-8">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E8E8E8] shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff] mb-4">
                ...
                <span className="text-xs font-medium text-[#4a5568]">Sign Up</span>
              </div>
              <h1 className="text-4xl font-bold mb-3 text-[#1a202c] leading-tight">Create your account</h1>
              <p className="text-[#4a5568] text-base">Join thousands of creators</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-2">
                <label htmlFor="name" className="block text-sm font-semibold text-[#2d3748]">
                  Full name
                </label>
                <div className="relative group">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 z-10">
                    <User className="h-5 w-5 text-[#4a5568] group-focus-within:text-[#1a202c] transition-colors" />
                  </div>
                  <input
                    id="name"
                    type="text"
              ...
              <div className="space-y-2">
                <label htmlFor="confirmPassword" className="block text-sm font-semibold text-[#2d3748]">
                  Confirm password
                </label>
                <div className="relative group">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 z-10">
            ...
            <div className="text-center">
              <p className="text-sm text-[#4a5568]">
                ...
                <Link href="/auth/sign-in" className="font-bold text-[#1a202c] hover:text-[#4a5568] transition-colors underline-offset-4 hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
